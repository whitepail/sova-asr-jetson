...
class RussianNumbers:
    def __init__(self):
        ...
        self.tokens = {
            ...
            "четвёртое": Numeral(4, 1, False),
            "четвертый": Numeral(4, 1, False),
            "четвёртый": Numeral(4, 1, False),
            "четвертая": Numeral(4, 1, False),
            "четвёртая": Numeral(4, 1, False),
            "четвертого": Numeral(4, 1, False),
            "четвёртого": Numeral(4, 1, False),
            "четвертой": Numeral(4, 1, False),
            "четвёртой": Numeral(4, 1, False),
            "четвертом": Numeral(4, 1, False),
            "четвёртом": Numeral(4, 1, False),
